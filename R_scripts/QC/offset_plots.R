...
for (sample in RPF_sample_names) {
  ...
  png(filename = file.path(parent_dir, paste0("plots/offset/", sample, "_start_site_offset.png")), width = 1000, height = 750)
  grid.arrange(start_site_plot_list[[29]], start_site_plot_list[[30]], start_site_plot_list[[31]],
               start_site_plot_list[[32]], start_site_plot_list[[33]], start_site_plot_list[[34]],
               start_site_plot_list[[35]], start_site_plot_list[[36]], start_site_plot_list[[37]], nrow = 3)
  dev.off()
  
  png(filename = file.path(parent_dir, paste0("plots/offset/", sample, "_stop_site_offset.png")), width = 1000, height = 750)
  grid.arrange(stop_site_plot_list[[29]], stop_site_plot_list[[30]], stop_site_plot_list[[31]],
               stop_site_plot_list[[32]], stop_site_plot_list[[33]], stop_site_plot_list[[34]],
               stop_site_plot_list[[35]], stop_site_plot_list[[36]], stop_site_plot_list[[37]], nrow = 3)
  dev.off()
}
...
png(filename = file.path(parent_dir, paste0("plots/offset/all_samples_start_site_offset.png")), width = 1000, height = 750)
grid.arrange(start_site_plot_list[[29]], start_site_plot_list[[30]], start_site_plot_list[[31]],
             start_site_plot_list[[32]], start_site_plot_list[[33]], start_site_plot_list[[34]],
             start_site_plot_list[[35]], start_site_plot_list[[36]], start_site_plot_list[[37]], nrow = 3)
dev.off()

png(filename = file.path(parent_dir, paste0("plots/offset/all_samples_stop_site_offset.png")), width = 1000, height = 750)
grid.arrange(stop_site_plot_list[[29]], stop_site_plot_list[[30]], stop_site_plot_list[[31]],
             stop_site_plot_list[[32]], stop_site_plot_list[[33]], stop_site_plot_list[[34]],
             stop_site_plot_list[[35]], stop_site_plot_list[[36]], stop_site_plot_list[[37]], nrow = 3)
dev.off()
