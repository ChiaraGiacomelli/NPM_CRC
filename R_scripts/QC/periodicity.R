...
for (sample in RPF_sample_names) {
  ...
  grid.arrange(plot_list[[29]], plot_list[[30]], plot_list[[31]],
               plot_list[[32]], plot_list[[33]], plot_list[[34]], 
               plot_list[[35]], plot_list[[36]], plot_list[[37]], nrow = 3)
  dev.off()
}
...
png(filename = file.path(parent_dir, paste0("plots/periodicity/all_samples_periodicity.png")), width = 500, height = 400)
print(periodicity_col_plot)
dev.off()
